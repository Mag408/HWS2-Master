...
function Clock() {
  ...
  const stringDate = `${date.toLocaleString("en", {
    day: "2-digit",
  })}.${date.toLocaleString("en", { month: "2-digit" })}.${date.toLocaleString(
    "en",
    { year: "numeric" }
  ...
  return (
    <div className={s.clock}>
      ...
      <div className={s.buttonsContainer}>
        <SuperButton
          id={"hw9-button-start"}
          disabled={disabledStartButton} // пишут студенты // задизэйблить если таймер запущен
          onClick={start}
        >
          start
        </SuperButton>
        <SuperButton
          id={"hw9-button-stop"}
          disabled={!disabledStartButton} // пишут студенты // задизэйблить если таймер не запущен
          onClick={stop}
        >
          stop
        </SuperButton>
